...
espacio vectorial. El modelo por defecto es <Tec id="modelos-de-recuperacion">SALAD</Tec>, entrenado específicamente
...
No todos entrenan igual: <Tec id="verificadores-geometricos">RoMa</Tec> hace algo distinto más adelante (comparar dos

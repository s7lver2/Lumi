...
pub async fn remove(
    ...
    guard(&app, &headers, id, true)?;
    {
        ...
        let sql = [
            ...
            // Sin esta, borrar un proyecto dejaba huérfanas para siempre las
            // filas de hipótesis de cada análisis suyo — nada las vuelve a
            // tocar ni las cuenta, así que solo crecen.

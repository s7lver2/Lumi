...
/** Vive en `ui/`, no en `settings/`: `App.tsx` la monta una sola vez para
 *  toda la app. Es local y descartable — cerrarla no vuelve a comprobar
 *  hasta el próximo arranque o hasta "Comprobar ahora" en Ajustes → Debug. */

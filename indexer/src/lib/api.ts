...
export const api = {
  ...
  descargaParalelaLeer: () => invoke<boolean>("descarga_paralela_leer"),
  descargaParalelaFijar: (activo: boolean) => invoke<void>("descarga_paralela_fijar", { activo }),
  qdrantMigrarOnDisk: () => invoke<string[]>("qdrant_migrar_on_disk"),
  discoWslEsMecanico: () => invoke<boolean | null>("disco_wsl_es_mecanico"),
